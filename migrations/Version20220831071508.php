 ...
 */
final class Version20220831071508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE user_id task INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task CHANGE task user_id INT DEFAULT NULL');
